...
@section('content')
		...
		<body background="{{ URL::asset('public/css/images/adjbackground.png') }}">
			<div id="topLeft">
			</div>
			<div id="header">
			...
			<div id="projectsPage">
				<br/>
                <table width="90%" height="334" align="center">
<!-- Possibly change font color to go along with scheme at later point -->
                <font color="#000000">
                	<tr class="row0">
                    <th width="50%" height="27"><h1> Project Name </h1></th>
                    <th width="50%"><h1> Date Last Saved </h1></th>
                    </tr>
                    <tr class="row1">
                    <th><h2> Project 1 </h2></th>
                    <th><h3> 10/22/1991 </h3></th>
                    </tr>
                    <tr class="row0">
                    <th><h2> Project 2 </h2></th>
                    <th><h3> 12/20/2013 </h3></th>
                    </tr>
                    <tr class="row1">
                    <th><h2> Project 3 </h2></th>
                    <th><h3> 01/26/2014 </h3></th>
                    </tr>
                </font>
                </table>
			</div>
